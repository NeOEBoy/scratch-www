    ...
    plugins: [
        ...
        .concat([
            new webpack.DefinePlugin({
                ...
                'process.env.API_HOST': '"' + (process.env.API_HOST || 'http://localhost:3001/scratch-api') + '"',
                ...
                'process.env.PROJECT_HOST': '"' + (process.env.PROJECT_HOST || 'http://localhost:3001/scratch-projects') + '"',
