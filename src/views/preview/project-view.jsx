...
class Preview extends React.Component {
  ...
  handleCopyProjectLink() {
    ...
    this.setState({ shareTipShow: true });
  }
  ...
  render() {
    ...
    return (
      <div>
        {this.state.shareTipShow ? (
          <div style={{ position: "fixed", zIndex: 500, backgroundColor: 'rgba(0,0,0,0.85)', width: '100%', height: '100%' }}
            onClick={() => {
              this.setState({ shareTipShow: false })
            }}>
            <img style={{ width: '100%' }} src={require('../../../static/images/test_result_share.png')} />
          </div>
        ) : null}
